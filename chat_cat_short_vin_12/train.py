...
from chat_cat_short_vin_12.feature_engineering import load_and_preprocess_data, extract_features
from chat_cat_short_vin_12.model_utils import RobustLabelEncoder, save_model, load_model
from chat_cat_short_vin_12.prefix_similarity import PrefixSimilarityEngine
...
def main():
    parser = argparse.ArgumentParser(description="Japanese Import 12-Character Short Chassis Model Training Pipeline")
    parser.add_argument(
        "--data_path",
        type=str,
        default="Data/final_clean_12.csv",
        help="Path to the cleaned 12-length chassis CSV file."
    )
    parser.add_argument(
        "--model_dir",
        type=str,
