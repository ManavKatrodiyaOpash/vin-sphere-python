...
from chat_cat_short_vin_12.feature_engineering import normalize_chassis, extract_features
from chat_cat_short_vin_12.model_utils import load_model
...
def get_model(target: str, model_dir: str = "chat_cat_short_vin_12/models") -> Any:
    """
...
def predict_vehicle(chassis_number: str, model_dir: str = "chat_cat_short_vin_12/models") -> Dict[str, Any]:
    """
    Decodes a 12-character short chassis number using the unified VINDecoder pipeline.
    """
    ...
    if os.path.exists(pipeline_path):
        try:
            ...
            from chat_cat_short_vin_12.vin_decoder import VINDecoder
...
def explain_prediction(chassis_number: str, target: str = "make", model_dir: str = "chat_cat_short_vin_12/models") -> Dict[str, Any]:
    """
...
def main():
    parser = argparse.ArgumentParser(description="Japanese Import 12-Character Short Chassis Model Inference Tool")
    parser.add_argument(
        "--chassis",
        type=str,
        required=True,
        help="12-character short chassis number string to decode."
    )
    parser.add_argument(
        "--model_dir",
        type=str,
        default="chat_cat_short_vin_12/models",
