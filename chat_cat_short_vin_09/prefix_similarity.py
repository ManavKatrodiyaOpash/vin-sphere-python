...
class PrefixSimilarityEngine:
    ...
    def fit(self, df: pd.DataFrame):
        ...
        2. Calculates Prefix Intelligence distributions for prefix_2 to prefix_6.
        """
        ...
        # Calculate Prefix Intelligence (prefix_2 to prefix_6 for 9-char VIN)
        self.prefix_stats = {}
    ...
    def get_prefix_intel(self, chassis: str) -> Dict[str, Any]:
        """
        Looks up prefix intelligence for the longest matching prefix (length 6 down to 2).
        """
        chassis = chassis.upper().strip()
